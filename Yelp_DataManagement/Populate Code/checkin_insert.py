...
def parse_db():
	...
	checklin = pd.read_csv("./data/checkin.csv", engine='python')
	checklin['date'] = checklin['date'].str.split(',').str.len()
	checklin.columns = ['business_id', 'number_of_checkins']
...
def main():
	...
	create_MySQL_table(db, "checkin_count", checkin_db, verbose = False)
